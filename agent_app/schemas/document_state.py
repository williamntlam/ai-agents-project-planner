...
class DocumentState(BaseModel):
    ...
    database_schema: Optional[str] = Field(
        None,
        description="Database schema design generated by DatabaseDesignerAgent"
    )
    """Complete database schema with CREATE TABLE statements, indexes, encryption specifications."""
